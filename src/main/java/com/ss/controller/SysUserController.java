...
public class SysUserController {
    ...
    public Json updateUserRole(@RequestBody String body) {
        ...
        //删除：原来绑定的角色
        boolean removeSucc = sysUserRoleService.remove(new QueryWrapper<SysUserRole>().eq("user_id", uid));
        if (!removeSucc) return Json.fail(oper, "无法解除原来的用户-角色关系");
