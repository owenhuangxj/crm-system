...
public class ExcelToCsv {
    ...
    public Integer consolidation(int beginSheetIndex, int EndSheetIndex, List<Integer> rowIndexList) {
        try {
            /*初始化输出流*/
            this.bw = new BufferedWriter(new OutputStreamWriter(new FileOutputStream(targetFile), "UTF-8"));
            /*遍历工作表*/
        ...
        return EndSheetIndex - beginSheetIndex;
    }
    ...
    public void delete() {
        if (this.targetFile != null) {
            new File(this.getTargetFile()).delete();
        } else {
